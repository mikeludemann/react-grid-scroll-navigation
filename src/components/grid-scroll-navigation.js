...
import './grid-scroll-navigation.css';

class GridScrollNavigation extends Component {
  constructor(props) {
    super(props)
    this.state = {}
  }
...
GridScrollNavigation.propTypes = {
...
class GridScrollNavigationElements extends Component {
	constructor(props) {
		super(props)
		this.state = {}
	}
	...
	render() {
		return (
			<a href={"#" + this.props.linkID} class="navi--link" aria-selected={this.props.status}>
				{this.props.children}
			</a>
		);
	}
...
GridScrollNavigationElements.propTypes = {
  children: PropTypes.element.isRequired,
